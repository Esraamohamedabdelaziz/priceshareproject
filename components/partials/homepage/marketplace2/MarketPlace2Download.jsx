                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                        <div className="ps-block__thumbnail">
                            <img src="/static/img/app.png" alt="PriceShare" />
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                        <div className="ps-block__content">
                            <h3>{t('download_priceshare')}</h3>
                            <p>
                                Enjoy a revolutionary shopping experience with
                                PriceShare mobile app. Get a link to download

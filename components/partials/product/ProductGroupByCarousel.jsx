...
const ProductGroupByCarousel = ({ vendor_id, title, layout = 'standard' }) => {
    const sliderRef = useRef(null);
    const { Translate: t } = useTranslation();

    const { productItems, loading, getFilterProductsCategories } =
        useGetProducts();

    useEffect(() => {
        getFilterProductsCategories('', 'best-sellers', vendor_id);
    }, [vendor_id]);
